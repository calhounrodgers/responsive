...
To use these stylesheets, rename the files and responsive with the name of your theme.
...
responsive-alpha-default-narrow.css  
...
responsive-alpha-default-normal.css
...
responsive-alpha-default-wide.css
